                ...
                child: Column(
                  children: [
                            ...
                            onPressed: () {
                              Navigator.push(
                                ...
                                MaterialPageRoute(
                                  builder:
                                      (context) => ProfilePage(
                                        user: GlobalUserInfo.currentUser,
                                      ),
                                ),
                              );
                            },
                    ...
                    Container(
                      ...
                      child: Container(
                        //PATCH DESCRIPTION //BACKEND
                        height: 120,
                        width: 300,
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(20),
                          border: Border.all(
                            color: Color.fromARGB(255, 239, 137, 255),
                            width: 3,
                          ),
                          color: Color.fromARGB(255, 234, 111, 255),
                          boxShadow: [
                      ...
                      children: [
                        Container(
                          ...
                          child: FloatingActionButton(
                            heroTag: "FAB6",
                            onPressed: () async {
                              //funktionalitet för delete-knapp
                              final patchProvider = Provider.of<PatchProvider>(
                                context,
                                listen: false,
                              );
                              ...
                              final bool confirm = await showDialog(
                                ...
                                builder:
                                    (context) => AlertDialog(
                                      title: Text('Radera märke'),
                                      content: Text(
                                        'Är du säker på att du vill ta bort detta märke?',
                                      ),
                                      actions: [
                                        TextButton(
                                          onPressed:
